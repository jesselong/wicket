 ...
 * @author Jesse Long
 */
public class RequestSettingRequestHandler implements IRequestHandler
{
	private final Request request;
	private final IRequestHandler wrappedRequestHandler;

	/**
	 * Creates a new instance
	 * @param request The request to use when responding
	 * @param wrappedRequestHandler The request handler to delegate responding to
	 */
	public RequestSettingRequestHandler(Request request, IRequestHandler wrappedRequestHandler)
	{
	 ...
	 */
	public IRequestHandler getWrappedRequestHandler()
	{
	...
	public void respond(IRequestCycle requestCycle)
	{
		...
		wrappedRequestHandler.respond(requestCycle);
	}

	@Override
	public void detach(IRequestCycle requestCycle)
	{
		wrappedRequestHandler.detach(requestCycle);
	}
}
